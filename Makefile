...
dist-thesis-extended:
	python3 scripts/validate_dataset_assets.py --registry datasets/registry/datasets.json --root .
	python3 scripts/validate_dataset_assets.py --registry datasets/registry/datasets_extended.json --root .
	python3 scripts/validate_thesis_evidence.py --root .
	python3 scripts/validate_thesis_extended_evidence.py --root .
	python3 -m compileall -q scripts ros2_ws/src tests
	timeout 30 bash scripts/secret_scan.sh
	bash scripts/make_dist_extended.sh
