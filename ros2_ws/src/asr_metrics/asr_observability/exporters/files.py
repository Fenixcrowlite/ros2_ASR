...
class FileTraceExporter:
    ...
    def _summary_row(trace: PipelineTrace) -> dict[str, Any]:
        return {
            ...
            "metrics_semantics_version": trace.metrics_semantics_version,
            "legacy_metrics": trace.legacy_metrics,
            "request_id": trace.request_id,
            "session_id": trace.session_id,
            "run_id": trace.run_id,
            "provider_id": trace.provider_id,
            "total_duration_ms": trace.total_duration_ms,
            "provider_compute_latency_ms": trace.metrics.get("provider_compute_latency_ms", 0.0),
            "end_to_end_latency_ms": trace.metrics.get("end_to_end_latency_ms", 0.0),
            ...
            "finalization_latency_ms": trace.metrics.get("finalization_latency_ms", ""),
            "time_to_result_ms": trace.metrics.get("time_to_result_ms", 0.0),
            "provider_compute_rtf": trace.metrics.get("provider_compute_rtf", 0.0),
            "end_to_end_rtf": trace.metrics.get("end_to_end_rtf", 0.0),
            "real_time_factor": trace.metrics.get("real_time_factor", 0.0),
            "measured_audio_duration_sec": trace.metrics.get("measured_audio_duration_sec", ""),
            "declared_audio_duration_sec": trace.metrics.get("declared_audio_duration_sec", ""),
            "duration_mismatch_sec": trace.metrics.get("duration_mismatch_sec", ""),
            "audio_duration_source": trace.metrics.get("audio_duration_source", ""),
            ...
            "cpu_percent_mean": trace.metrics.get("cpu_percent_mean", ""),
            "cpu_percent_peak": trace.metrics.get("cpu_percent_peak", ""),
            "memory_mb_mean": trace.metrics.get("memory_mb_mean", ""),
            "memory_mb_peak": trace.metrics.get("memory_mb_peak", ""),
            "gpu_util_percent_mean": trace.metrics.get("gpu_util_percent_mean", ""),
            "gpu_util_percent_peak": trace.metrics.get("gpu_util_percent_peak", ""),
            "gpu_memory_mb_mean": trace.metrics.get("gpu_memory_mb_mean", ""),
            "gpu_memory_mb_peak": trace.metrics.get("gpu_memory_mb_peak", ""),
