...
def test_benchmark_orchestrator_streaming_records_streaming_metrics(tmp_path: Path, sample_wav: str) -> None:
    ...
    _write_yaml(configs / "providers" / "fake_stream.yaml", {"provider_id": "fake_stream_component", "settings": {}})
    ...
    _write_yaml(
        ...
        {"metrics": ["wer", "first_partial_latency_ms", "finalization_latency_ms", "partial_count"]},
    )
    _write_yaml(
        configs / "benchmark" / "bench.yaml",
        {
