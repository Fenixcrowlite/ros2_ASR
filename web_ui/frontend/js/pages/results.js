  ...
  return `
    <div class="stack-item">
      ...
      ${renderMetaGrid(ui, [
        ...
        { label: 'Latency ms', value: metricText(metricValue(row, 'end_to_end_latency_ms')) },
        { label: 'RTF', value: metricText(metricValue(row, 'end_to_end_rtf')) },
  ...
  return `
    <div class="stack-item">
      ...
      ${renderMetaGrid(ui, [
        ...
        { label: 'Latency ms', value: metricText(firstPresent(metrics.end_to_end_latency_ms, metrics.time_to_final_result_ms)) },
        { label: 'RTF', value: metricText(metrics.end_to_end_rtf) },
    ...
    <div class="stack-item">
      ...
      ${renderMetaGrid(ui, [
        ...
        { label: 'Provider ms', value: metricText(metrics.provider_compute_latency_ms) },
  ...
  function renderRunOverview(detail) {
    ...
    runDetailRoot.innerHTML = `
      ...
      <div class="stack-item">
        ...
        <p>metrics_semantics=${ui.escapeHtml(String(summary.metrics_semantics_version || 2))}</p>
      </div>
      ${
        bestProvider
          ? `
    ...
    providerTableRoot.innerHTML = ui.table(
      [
        ...
        },
        {
          key: 'latency',
          label: 'End-to-End ms',
          value: (row) => ui.escapeHtml(metricText(metricValue(row, 'end_to_end_latency_ms'))),
        },
        {
          key: 'rtf',
          label: 'RTF',
          value: (row) => ui.escapeHtml(metricText(metricValue(row, 'end_to_end_rtf'))),
        },
        {
          key: 'cost',
          label: 'Cost USD',
    ...
    sampleTableRoot.innerHTML = ui.table(
      [
        ...
        { key: 'cer', label: 'CER', value: (row) => ui.escapeHtml(metricText(metricValue(row, 'cer'))) },
        {
          ...
          label: 'Latency ms',
          value: (row) =>
            ui.escapeHtml(metricText(metricValue(row, 'end_to_end_latency_ms', ['time_to_final_result_ms']))),
        },
